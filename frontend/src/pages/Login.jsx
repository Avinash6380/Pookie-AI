    ...
    <div style={{
      ...
      <div className="glass-card" style={{
        ...
        <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Login to chat with your AI companion</p>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '6px 0', gap: '10px' }}>
          ...
          <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontFamily: 'Outfit, sans-serif' }}>or connect with</span>
          <div style={{ flexGrow: 1, height: '1px', background: 'var(--card-border)' }} />
        </div>
